              ...
              <div className="col l12 content-center">
                ...
                <div className="row">
                  <span className="primary-white-color">
                    <p className="home-about-name-dummy primary-white-color">
                      My Name Is
                    </p>
                    <p className="home-about-name-main primary-white-color">
                      Md. Iftekhar Uddin Emon
                    </p>
                  </span>
                </div>
                <div className="row">
                  <p className="home-about-designation">
                ...
                <div className="row home-about-signature">
                  <div className="col s1 content-center">
                    <div className="row">
                      <p className="home-about-signature-title">
                        Best
                        <br />
                        Regards
                      </p>
                  ...
                  <div className="col s4 content-center">
                    <div className="row">
                      <img
                        src="./assets/images/signature.png"
                        alt="Signature"
                        className="home-about-signature-image"
                      />
                    </div>
                  </div>
                </div>
