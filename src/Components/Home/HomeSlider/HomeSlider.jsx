...
class HomeSlider extends Component {
    ...
    state = {}
  componentDidMount(){
    let slider = new SliderService('home-slider', 'home-slider-container', 'dot', 'active', 3);
    // let x  = 10;
        ...
        <div className="row dot-wrapper">
          <div className="container-fluid home-slider-bubble">
            <div className="row justify-content-center">
              <span className="dot active align-self-center" onClick={() => this.handleHomeSlider(0)}/>
