...
class HomeTestimonial extends Component {
  state = {};
  componentDidMount() {
    let slider = new CarosellService(
      "testimonial-slider",
                          ...
                          <div className="row content-center justify-center">
                            <div className="col l6 m6 s9 testimonial-quote-text-wrapper">
                              <p className="testimonial-quote-text">
                                ...
                                eget suscipit sit amet, finibus nec arcu. Etiam
                                venenatis efficitur mollis. Nulla ac rhoncus
                                risus, et semper nisl. Aliquam vehicula orci sed
                                ex commodo mattis. Aliquam erat volutpat. Nunc
                                egestas sapien porttitor ante dapibus dapibus.
                                Morbi lacinia mauris id rhoncus egestas. Sed
                                ultrices eros vel fringilla molestie.
                              </p>
                            </div>
                          </div>
