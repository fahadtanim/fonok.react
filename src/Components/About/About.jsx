        ...
        <div className="container about-box-wrapper">
          <div className="row about-details-container">
            <div className="col s6">
              ...
              <div className="row">
                <a href="#" className="col s4 about-photobox-grid">
                  <div
              ...
              {/* <div className="row">
                <div className="col s6">
                  <div className="row">
                    <img
                      src="./assets/images/lens-hood.png"
                      alt="camera-icon.png"
                      className="about-icon content-center"
                    />
                    <span className="about-icon-counter primary-red-color">
                      132
                    </span>
                    <span className="col s5 about-icon-details content-center ">
                      Pounds of Equipment
                    </span>
                  </div>
                </div>
                ...
                <div className="col s6">
                  <div className="row">
                    ...
                    <span className="col-5 about-icon-details content-center ">
                      Finished Photosessions
                    </span>
                  </div>
                </div>
            ...
            <div className="col s6 about-photo-container">
              <div
            ...
            <div className="container">
              <div className="row">
                <div className="col s12">
                  ...
                  <div className="row about-photobox-wrapper">
                    <a href="#" className="col s4 about-photobox-grid">
                      <div
                        className="row about-photobox-img-container"
                        style={{
                          backgroundImage:
                            "url('assets/images/price-list2.jpg')"
                        }}
                      >
                        <div>
                          <h6>Product Photography</h6>
                    ...
                    <a href="#" className="col s4 about-photobox-grid">
                      <div
                        ...
                        style={{
                          backgroundImage:
                            "url('assets/images/price-list3.jpg')"
                        }}
                      >
                        <div>
                          <h6>Portfolio Photography</h6>
                        </div>
                      </div>
                    </a>
                    <a href="#" className="col s4 about-photobox-grid">
                      <div
                        ...
                        style={{
                          backgroundImage:
                            "url('assets/images/bg-about-me.jpg')"
                        }}
                      >
                        <div>
